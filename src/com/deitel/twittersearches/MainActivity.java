...
public OnCheckedChangeListener radioListener = new OnCheckedChangeListener() {
      ...
      public void onClick(View v) 
      {
            ...
            tagEditText.getText().length() > 0)
         {
            addTaggedSearch(queryEditText.getText().toString(), 
               tagEditText.getText().toString(), mode);
   ...
   private void addTaggedSearch(String query, String tag, String mode)
   {
   ...
   OnItemClickListener itemClickListener = new OnItemClickListener() 
   {
         ...
         int position, long id) 
      {
         ...
         String urlString = getString(R.string.searchURL) +
            Uri.encode(savedSearches.getString(tag, ""), "UTF-8") + "&mode=" + mode;
